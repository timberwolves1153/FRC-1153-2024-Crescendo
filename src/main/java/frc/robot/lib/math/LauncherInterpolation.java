...
// value = rpm setpoint
    static {    
        ...
        pivotMap.put(new InterpolatingDouble(2.61), new InterpolatingDouble(37.8));
        ...
        pivotMap.put(new InterpolatingDouble(3.84), new InterpolatingDouble(26.0));
        pivotMap.put(new InterpolatingDouble(4.01), new InterpolatingDouble(25.5));
        pivotMap.put(new InterpolatingDouble(4.22), new InterpolatingDouble(24.2));
        pivotMap.put(new InterpolatingDouble(4.41), new InterpolatingDouble(23.4));
